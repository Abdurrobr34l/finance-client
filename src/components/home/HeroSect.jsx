  ...
  return (
    <section className="relative overflow-hidden sectionPadding 2xl:py-25!">
      ...
      <Container className="relative z-10">
        ...
        {/* MAIN CARD */}
        <div className="relative mx-auto mt-15 rounded-2xl bg-accent/10 p-5 pb-0! shadow-[0_20px_70px_rgba(56,189,248,0.35)] md:p-10 lg:px-15 xl:lg:px-20 xl:lg:pt-15 xl:rounded-3xl">
